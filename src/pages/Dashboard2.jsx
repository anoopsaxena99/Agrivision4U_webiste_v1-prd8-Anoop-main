...
import CardCorrect from "./CardCorrect";
import styles from "./cardcorrect.module.css";
import FrequentCorrect from "./FrequentCorrect";
import AlertCorrect from "./AlertCorrect";
import GreetingCardCorrect from "./GreetingCardCorrect";
    ...
    <Dash>
      {user && userprog ? (
        <div>
          ...
          <FrequentCorrect></FrequentCorrect>
          {/* the faqs */}
          {/* for courses go to courses.jsx */}
          <Footer />
        </div>
      ) : (
        <Loader></Loader>
