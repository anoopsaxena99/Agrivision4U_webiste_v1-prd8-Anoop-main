  ...
  return (
    <Router>
      <Switch>
        ...
        <ProtectedRoute
          path="/free-trial/package/:id"
          exact
          component={TrialPackage}
        />
        <ProtectedRoute
          path="/free-trial/course/:id"
          exact
          component={TrialCourse}
        />
        <ProtectedRoute
          path="/free-trial/course/:id1/:id2"
          exact
          component={TrialChapter}
        />
        <ProtectedRoute
          path="/free-trial/testseries/:id"
          exact
        ...
        <Route
          path="/testseries/subject=:name"
          exact
          component={Subjectnames}
        />
        <ProtectedRoute
          path="/testseries/:id"
          exact
          component={TestseriesSpecific}
        />
        <ProtectedRoute
          path="/prevpapers/exam=:name"
          exact
          component={ExamSpecificPapers}
        />
