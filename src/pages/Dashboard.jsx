    ...
    <Dash>
      {user && userprog ? (
        <div>
          <Navbar></Navbar>
          <DashWrapper>
            {/* welcome page at top left and the right has the Goal completed */}
            <DashHead>
              {/* welcome page at top left */}
              <div className="Welcome">
                <div className="Welcome-krishna">
                  Welcome {user.name[0]} {user.name[1]}
                </div>
                ...
                <div>
                  <span className="P2">
                    There are some new courses for you,{" "}
                  </span>
                  <Link to="courses">
                ...
                <div>
                  ...
                  {userprog.data.lastCompleted.courseId &&
                  userprog.data.lastCompleted.chapterId ? (
                    <Link
                      to={`/course/${userprog.data.lastCompleted.courseId}/${userprog.data.lastCompleted.chapterId}`}
                    >
            ...
            {/* currently ongoing Courses and the right has calander*/}
            <DashBody>
              {/* currently ongoing Courses */}
              <DashCardCont>
                <DashCardContHead>
                  <h1>Your Courses</h1>
                  <span className="dashCard__ongoing">
                    {user.courses.length} ongoing
                  </span>
          ...
          <nav className={sidebar ? "nav-menu active" : "nav-menu"}>
            <ul className="nav-menu-items">
              ...
              <DashScheduldeSidebar user={user} />
            </ul>
          </nav>
